...
@numba.njit(numba.types.UniTuple(numba.types.UniTuple(numba.int64, 2), 3)(numba.int64))
def gen_first_ring_strongholds(seed):
    ...
    seed, rand_2 = java_random.next_double(seed)
    seed, rand_3 = java_random.next_double(seed)
